...
export class NavbarComponent implements OnInit {
  ...
  public logoSrc2: string = 'assets/public/images/JuiceShopCTF_Logo.png'
  ...
  constructor (private readonly administrationService: AdministrationService, private readonly challengeService: ChallengeService,
    ...
    private readonly snackBar: MatSnackBar, private readonly basketService: BasketService, @Inject(DOCUMENT) private document: Document) { }
  ...
  goToUrl () {
    this.document.location.href = 'http://localhost:3001/#/'
  }
}

...
export class UserService {
  ...
  changePasswordSecure (data: resetData) {
    return this.http.get(this.hostServer + '/rest/change-password-secure?token=' + data.token + '&new=' +
    data.new + '&repeat=' + data.repeat).pipe(map((response: any) => response.user), catchError((err) => { throw err.error })) 
  }

...
import { ChangePasswordSecureComponent } from './change-password-secure/change-password-secure.component'
...
const routes: Routes = [
  ...
  {
    path: 'change-password-secure',
    component: ChangePasswordSecureComponent
  },
  {
    path: 'juicy-nft',
